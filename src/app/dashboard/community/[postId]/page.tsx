...
const PostPage = () => {
  ...
  if (postLoading) {
    return <DashboardLayout><div className="flex justify-center items-center h-96"><Loader2 className="h-12 w-12 animate-spin text-primary" /></div></DashboardLayout>;
  }

  if (postError || !post) {
    return <DashboardLayout><div className="text-center py-12">
