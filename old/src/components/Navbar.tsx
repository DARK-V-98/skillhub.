            ...
            <DropdownMenuContent align="end" className="w-56 bg-popover">
              <DropdownMenuLabel>
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-normal text-muted-foreground">{currentUser.email}</span>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="cursor-pointer btn-touch-target text-destructive">
